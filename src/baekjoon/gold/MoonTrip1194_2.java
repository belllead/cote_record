...
//			System.out.println(Arrays.toString(c));
		...
		bfs(start[0], start[1], -1, maze, keyOK);
	...
	private static void bfs(int row, int col, int cnt, char[][] maze, int[] keyOK) {
			...
			while (size-- > 0) {
				...
				for (int i=0; i<6; i++) {
					if (maze[curr[0]][curr[1]] == key[i]) {
						...
						bfs(curr[0], curr[1], cnt-1, maze, keyOK);
